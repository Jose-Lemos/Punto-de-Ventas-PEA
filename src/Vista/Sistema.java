...
public final class Sistema extends javax.swing.JFrame {
    ...
    boolean is_config_register = false;
    ...
    public Sistema (login priv){
        ...
        if (priv.getRol().equals("Asistente")) {
            ...
            LabelVendedor.setText(priv.getNombre()+"("+priv.getRol()+")");
        }else{
            LabelVendedor.setText(priv.getNombre()+"("+priv.getRol()+")");
        }
    }
    ...
    public void ListarConfig() {
        List<Config> ListarConf = config.ListarConfig();
        if (ListarConf.size()>0){
            is_config_register = true;
            btnRegistrarConfig.setEnabled(false);
            btnActualizarConfig.setEnabled(true);
            conf.setId(ListarConf.get(0).getId());
            conf.setRuc(ListarConf.get(0).getRuc());
            conf.setNombre(ListarConf.get(0).getNombre());
            conf.setTelefono(ListarConf.get(0).getTelefono());
            conf.setDireccion(ListarConf.get(0).getDireccion());
            conf.setMensaje(ListarConf.get(0).getMensaje());
    ...
    private void initComponents() {
        ...
        btnExcelVent = new javax.swing.JButton();
        ...
        btnRegistrarConfig = new javax.swing.JButton();
        ...
        btnExcelProv.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnExcelProvActionPerformed(evt);
            }
        });
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel10Layout.createSequentialGroup()
                .addGroup(jPanel10Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(jPanel10Layout.createSequentialGroup()
                        ...
                        .addGap(24, 24, 24)
                        .addGroup(jPanel10Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(txtTelefonoProveedor, javax.swing.GroupLayout.DEFAULT_SIZE, 161, Short.MAX_VALUE)
        ...
        jPanel6.add(txtIdVenta, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 50, 46, -1));
        ...
        btnExcelVent.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/excel.png"))); // NOI18N
        btnExcelVent.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnExcelVentActionPerformed(evt);
            }
        });
        jPanel6.add(btnExcelVent, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 40, -1, -1));
        ...
        btnRegistrarConfig.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/GuardarTodo.png"))); // NOI18N
        btnRegistrarConfig.setText("REGISTRAR");
        btnRegistrarConfig.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnRegistrarConfigActionPerformed(evt);
            }
        });
        ...
        jPanel8Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel8Layout.createSequentialGroup()
                ...
                .addComponent(btnRegistrarConfig)
                .addGap(39, 39, 39)
                ...
                .addGroup(jPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel8Layout.createSequentialGroup()
                        .addGroup(jPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(btnRegistrarConfig, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jLabel38.setText("Desarrollado por: José Lemos");
    ...
    private void btnActualizarConfigActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnActualizarConfigActionPerformed
        // TODO add your handling code here:
        if (is_config_register == true){
            if (!"null".equals(txtRucConfig.getText()) && !"null".equals(txtNombreConfig.getText()) && !"null".equals(txtTelefonoConfig.getText()) && !"null".equals(txtDireccionConfig.getText()) && !"null".equals(txtMensaje.getText())){

                if (!"".equals(txtRucConfig.getText()) && !"".equals(txtNombreConfig.getText()) && !"".equals(txtTelefonoConfig.getText()) && !"".equals(txtDireccionConfig.getText()) && !"".equals(txtMensaje.getText())){
                    conf.setId(1);
                    ...
                    config.ModificarConfig(conf);
                    JOptionPane.showMessageDialog(null, "Los Datos de la Empresa han sido Actualizados!!");
                }else{
                    JOptionPane.showMessageDialog(null, "Los campos NO PUEDEN ESTAR VACIOS!!");
                    ListarConfig();
                }
            }else{
                JOptionPane.showMessageDialog(null, "Los campos tienen  que ser DISTINTO de 'null'!!");
                ListarConfig();
            }
        }else{
    ...
    private void btnExcelProvActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcelProvActionPerformed
        // TODO add your handling code here:
        Excel.reporteProveedores();
    }//GEN-LAST:event_btnExcelProvActionPerformed

    private void btnExcelVentActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcelVentActionPerformed
        // TODO add your handling code here:
        Excel.reporteVentas();
    }//GEN-LAST:event_btnExcelVentActionPerformed
    ...
    private void btnRegistrarConfigActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarConfigActionPerformed
        // TODO add your handling code here:
        try{
        if (is_config_register==true){
            if (!"null".equals(txtRucConfig.getText()) && !"null".equals(txtNombreConfig.getText()) && !"null".equals(txtTelefonoConfig.getText()) && !"null".equals(txtDireccionConfig.getText()) && !"null".equals(txtMensaje.getText())){
            ...
            if (!"null".equals(txtRucConfig.getText()) && !"null".equals(txtNombreConfig.getText()) && !"null".equals(txtTelefonoConfig.getText()) && !"null".equals(txtDireccionConfig.getText()) && !"null".equals(txtMensaje.getText())){
                if (!"".equals(txtRucConfig.getText()) && !"".equals(txtNombreConfig.getText()) && !"".equals(txtTelefonoConfig.getText()) && !"".equals(txtDireccionConfig.getText()) && !"".equals(txtMensaje.getText())) {
                    ...
                    conf.setDireccion(txtDireccionConfig.getText());
                    conf.setMensaje(txtMensaje.getText());
                    is_config_register = config.RegistrarConfig(conf);
                    btnActualizarConfig.setEnabled(true);
                    btnRegistrarConfig.setEnabled(false);
                    JOptionPane.showMessageDialog(null, "Empresa Registrada");
                    ListarConfig();
                } else {
                        JOptionPane.showMessageDialog(null, "Hay campos que están vacios!! Por Favor Complete Todos los Campos!!");
                }
            }else{
                JOptionPane.showMessageDialog(null, "Los campos No pueden ser Nulos o Estar Vacios!!");
            }
        }
        }catch (Exception e) {
                JOptionPane.showMessageDialog(null, "Los campos No pueden ser Nulos o Estar Vacios");
    ...
    }//GEN-LAST:event_btnRegistrarConfigActionPerformed
    ...
    private javax.swing.JButton btnExcelVent;
    ...
    private javax.swing.JButton btnRegistrarConfig;
